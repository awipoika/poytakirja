...
<div class="row">
  ...
  while($t = $nayta -> fetch_object()){
    echo '<div class="row">';
    echo '<div class="small-6 medium-6 large-8 columns">'.'<td><a href="' . $t -> Vuosi .'.php">'. $t -> Vuosi ."</a></td>" . '</div>';
    echo '<div class="small-6 medium-3 large-2 columns">'.'<a href="'. $t -> Vuosii .'.php">'. $t -> Vuosii ."</a>" .'</div>';
    echo '<div class="small-6 medium-3 large-2 columns">'. "<p>". $t -> Dokumentti ."</p>".'</div>';
    echo '</div>';
       }  
